...
public:
	...
	/**
	*Add a sound to the word
	*@param int iType: The type of the sound (see sound.h)
	*@param const Vector &vecOrigin:The origin of the sound
	*@param int iVolume:The volume of the sound
	*@param float flDuration: The duration of the sound in seconds
	*/
