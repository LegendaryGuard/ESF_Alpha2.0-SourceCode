...
/**
* Draws a red-green bar on the hud
* @param int x: x location of left corner
* @param int y: y location of left corner
* @param int width: width of the bar
* @param int height: length of the bar
* @param float f: 0...1.0, how much too fill this bar
* @return int: x location of right corner 
*/
